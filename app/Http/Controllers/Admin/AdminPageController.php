...
class AdminPageController extends Controller
{
    ...
    {
        $page_data = Page::where('id', 1)->first();
        return view('admin.page_reservation', compact('page_data'));
    }

    public function reservation_update(Request $request)
    {
        $obj = Page::where('id', 1)->first();
        $obj->reservation_heading = $request->reservation_heading;
        $obj->reservation_status = $request->reservation_status;
        $obj->update();
